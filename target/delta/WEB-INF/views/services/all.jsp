...
<div class="boxed-container">
    ...
    <div class="breadcrumbs ">
        <div class="container">
            <span typeof="v:Breadcrumb"><a title="Go to Deltamer." href="<c:url value="/"/>"
                                           class="home">Deltamer</a></span>
            <span typeof="v:Breadcrumb"><span>Our Services</span></span>
        </div>
    </div>
            ...
            <div class="row">
                <main class="col-xs-12  col-md-9  col-md-push-3" role="main">
                    <div class="row is-flex">
                        <c:forEach items="${services}" var="services">
                            <div class="services col-md-4 page-box page-box--block">
                                <a href="<c:url value="/services/servicesView/${services.servicesId}"/>"
                        ...
                        <div class="widget widget_nav_menu  push-down-30">
                            <div class="menu-services-menu-container">
                                <ul id="menu-services-menu" class="menu">
                                    <li class="current-menu-item"><a href="<c:url value="/services/all"/>">ALL SERVICES</a></li>
                                    <c:forEach items="${services}" var="services">
                                        <li><a href="<c:url value="/services/servicesView/${services.servicesId}"/>"
                                               title="Go to <c:out value="${services.title}"/>">
                                            <div class="text">
